package com.github.gtexpert.gtmt.loaders.recipe.handlers;
...
public class ModImplosionRecipeHandler {
    ...
    public static void add(Material inputMaterial, Material outputMaterial) {
        register(
                ...
                () -> ModImplosionNoBombRecipeHandler.add(inputMaterial, outputMaterial));
    }
    ...
    public static void add(Material inputMaterial, ItemStack outputStack) {
        register(
                ...
                () -> ModImplosionNoBombRecipeHandler.add(inputMaterial, outputStack));
    }
    ...
    public static void add(String inputOreDict, ItemStack outputStack) {
        register(
                ...
                () -> ModImplosionNoBombRecipeHandler.add(inputOreDict, outputStack));
    }
