package com.github.gtexpert.gtmt.integration.tc.recipes;
    ...
    public static void init() {
        if (ConfigHolder.recipes.hardToolArmorRecipes) {
            ...
            ModHandler.addShapedRecipe(true, "thaumium_helm",
                    ...
                    "PPP", "PhP",
                    'P', OreDictUnifier.get(plate, ModMaterials.Thaumium));
            ...
            ModHandler.addShapedRecipe(true, "void_helm",
                    ...
                    "PPP", "PhP",
                    'P', OreDictUnifier.get(plate, ModMaterials.VoidMetal));
            ...
            ModHandler.addShapedRecipe(true, "thaumium_axe",
                    ...
                    "PIf", "PS ", "hS ",
                    'P', OreDictUnifier.get(plate, ModMaterials.Thaumium),
                    'I', OreDictUnifier.get(ingot, ModMaterials.Thaumium),
            ...
            ModHandler.addShapedRecipe(true, "void_axe",
                    ...
                    "PIf", "PS ", "hS ",
                    'P', OreDictUnifier.get(plate, ModMaterials.VoidMetal),
                    'I', OreDictUnifier.get(ingot, ModMaterials.VoidMetal),
                    'S', OreDictUnifier.get(stick, Materials.Wood));
