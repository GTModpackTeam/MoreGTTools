    ...
    public static void init() {
        if (ConfigHolder.recipes.hardToolArmorRecipes) {
            ...
            ModHandler.addShapedRecipe(true, "dark_steel_helmet",
                    ...
                    "PPP", "PhP",
                    'P', OreDictUnifier.get(plate, ModMaterials.DarkSteel));
            ...
            ModHandler.addShapedRecipe(true, "end_steel_helmet",
                    ...
                    "PPP", "PhP", " G ",
                    'P', OreDictUnifier.get(plate, ModMaterials.EndSteel),
            ...
            ModHandler.addShapedRecipe(true, "stellar_alloy_helmet",
                    ...
                    "PPP", "PhP", " G ",
                    'P', OreDictUnifier.get(plate, ModMaterials.StellarAlloy),
            ...
            ModHandler.addShapedRecipe(true, "dark_steel_axe",
                    ...
                    "PIf", "PS ", "hS ",
                    'P', OreDictUnifier.get(plate, ModMaterials.DarkSteel),
                    'I', OreDictUnifier.get(ingot, ModMaterials.DarkSteel),
                    'S', OreDictUnifier.get(stick, ModMaterials.DarkSteel));
            ...
            ModHandler.addShapedRecipe(true, "dark_steel_shears",
                    ...
                    "PTP", "hRf", "SsS",
                    'P', OreDictUnifier.get(plate, ModMaterials.DarkSteel),
                    'T', OreDictUnifier.get(screw, ModMaterials.DarkSteel),
                    'R', OreDictUnifier.get(ring, ModMaterials.DarkSteel),
                    'S', OreDictUnifier.get(stick, ModMaterials.DarkSteel));
            ...
            ModHandler.addShapedRecipe(true, "dark_steel_shield",
                    ...
                    "BSB", "LPL", "BSB",
                    'B', OreDictUnifier.get(bolt, ModMaterials.DarkSteel),
                    'S', OreDictUnifier.get(stick, ModMaterials.DarkSteel),
                    'L', OreDictUnifier.get(stickLong, ModMaterials.DarkSteel),
                    'P', OreDictUnifier.get(plate, ModMaterials.DarkSteel));
            ...
            ModHandler.addShapedRecipe(true, "ender_steel_axe",
                    ...
                    "PIf", "PG ", "hS ",
                    'P', OreDictUnifier.get(plate, ModMaterials.EndSteel),
                    'I', OreDictUnifier.get(ingot, ModMaterials.EndSteel),
                    'G', new ItemStack(ModObject.itemMaterial.getItemNN(), 1, 56),
                    'S', OreDictUnifier.get(stickLong, ModMaterials.EndSteel));
            ...
            ModHandler.addShapedRecipe(true, "ender_steel_bow",
                    ...
                    "hSW", "PRW", "fSW",
                    'S', OreDictUnifier.get(stick, ModMaterials.EndSteel),
                    'W', new ItemStack(Items.STRING, 1),
                    'P', new ItemStack(ModObject.itemMaterial.getItemNN(), 1, 45),
                    'R', OreDictUnifier.get(ring, ModMaterials.EndSteel));

            // Ender Shield
            ModHandler.addShapedRecipe(true, "ender_steel_shield",
                    new ItemStack(ModObject.itemEndSteelShield.getItemNN(), 1),
                    "BSB", "LPL", "BSB",
                    'B', OreDictUnifier.get(bolt, ModMaterials.EndSteel),
                    'S', OreDictUnifier.get(stick, ModMaterials.EndSteel),
                    'L', OreDictUnifier.get(stickLong, ModMaterials.EndSteel),
                    'P', OreDictUnifier.get(plate, ModMaterials.EndSteel));
            ...
            ModHandler.addShapedRecipe(true, "stellar_alloy_axe",
                    ...
                    "PIf", "PO ", "hS ",
                    'P', OreDictUnifier.get(plate, ModMaterials.StellarAlloy),
                    'I', OreDictUnifier.get(ingot, ModMaterials.StellarAlloy),
                    'O', new ItemStack(ModObject.itemMaterial.getItemNN(), 1, 44),
                    'S', OreDictUnifier.get(stickLong, ModMaterials.StellarAlloy));
            ...
            ModHandler.addShapedRecipe(true, "yeta_wrench", new ItemStack(ModObject.itemYetaWrench.getItemNN(), 1),
                    "PhP", " P ", " P ",
                    'P', OreDictUnifier.get(plate, ModMaterials.ElectricalSteel));
        }
    }
}
