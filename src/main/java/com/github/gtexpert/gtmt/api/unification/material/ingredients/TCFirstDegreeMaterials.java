...
import static com.github.gtexpert.gtmt.api.unification.ModElements.*;
...
public class TCFirstDegreeMaterials {
    ...
    public static void init() {
        // Thaumium
        Thaumium = new Material.Builder(24191, id("thaumium"))
                .dust(3).ingot(3)
        ...
        // Void Metal
        VoidMetal = new Material.Builder(24192, id("void_metal"))
                .dust(4).ingot(4)
                .liquid(new FluidBuilder().temperature(1200))
