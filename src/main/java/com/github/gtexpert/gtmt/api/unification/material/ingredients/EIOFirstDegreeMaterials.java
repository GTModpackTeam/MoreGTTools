package com.github.gtexpert.gtmt.api.unification.material.ingredients;

import static com.github.gtexpert.gtmt.api.unification.material.ModMaterials.*;
...
public class EIOFirstDegreeMaterials {
    ...
    public static void init() {
        // Soulsand Dust
        SoulSand = new Material.Builder(24101, id("soul_sand"))
                .dust()
        ...
        // Chorusfruit Dust
        ChorusFruit = new Material.Builder(24102, id("chorus_fruit"))
                .dust()
        ...
        // Electrical Steel
        ElectricalSteel = new Material.Builder(24103, id("electrical_steel"))
                .ingot()
                ...
                .blast(b -> b
                        ...
                        .blastStats(VA[ModValues.eioVoltageTier], 120)
                        .vacuumStats(VA[ModValues.eioVoltageTier], 30))
                .build();

        // Energetic Alloy
        EnergeticAlloy = new Material.Builder(24104, id("energetic_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
        ...
        // Vibrant Alloy
        VibrantAlloy = new Material.Builder(24105, id("vibrant_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
        ...
        // Redstone Alloy
        RedstoneAlloy = new Material.Builder(24106, id("redstone_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
        ...
        // Conductive Iron
        ConductiveIron = new Material.Builder(24107, id("conductive_iron"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
        ...
        // Pulsating Iron
        PulsatingIron = new Material.Builder(24108, id("pulsating_iron"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
                ...
                .blast(b -> b
                        .temp(2700, GasTier.HIGH)
                        .blastStats(VA[ModValues.eioVoltageTier], 120)
                        .vacuumStats(VA[ModValues.eioVoltageTier]))
                .build();

        // Dark Steel
        DarkSteel = new Material.Builder(24109, id("dark_steel"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
        ...
        // Soularium
        Soularium = new Material.Builder(24110, id("soularium"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
                ...
                .blast(b -> b
                        ...
                        .blastStats(VA[ModValues.eioVoltageTier], 600)
                        .vacuumStats(VA[ModValues.eioVoltageTier], 150))
                .build();

        // End Steel
        EndSteel = new Material.Builder(24111, id("end_steel"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
                ...
                .blast(b -> b
                        ...
                        .blastStats(VA[ModValues.eioVoltageTier] + 1, 1072)
                        .vacuumStats(VA[ModValues.eioVoltageTier] + 1, 268))
                .build();
        EndSteel.setFormula(
        ...
        // Iron Alloy
        ConstructionAlloy = new Material.Builder(24112, id("construction_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
        ...
        // Crystalline Alloy
        CrystallineAlloy = new Material.Builder(24113, id("crystalline_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
                ...
                .blast(b -> b
                        .temp(4500, GasTier.HIGHER)
                        .blastStats(VA[ModValues.eioVoltageTier] + 1, 600)
                        .vacuumStats(VA[ModValues.eioVoltageTier] + 1, 150))
                .build();

        // Melodic Alloy
        MelodicAlloy = new Material.Builder(24114, id("melodic_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
        ...
        // Stellar Alloy
        StellarAlloy = new Material.Builder(24115, id("stellar_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
                ...
                .blast(b -> b
                        ...
                        .blastStats(VA[ModValues.eioVoltageTier] + 3, 600)
                        .vacuumStats(VA[ModValues.eioVoltageTier] + 3, 150))
                .build();

        // Crystalline Pink Slime
        CrystallinePinkSlime = new Material.Builder(24116, id("crystalline_pink_slime"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
        ...
        // Energetic Silver
        EnergeticSilver = new Material.Builder(24117, id("energetic_silver"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
        ...
        // Vivid Alloy
        VividAlloy = new Material.Builder(24118, id("vivid_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1200))
